...
public class Log extends AppCompatActivity implements View.OnClickListener
{
    ...
    public void onClick(View view)
    {
        ...
        case R.id.addLogButton:
            Intent createLogEntry = new Intent(this, Camera.class);
    ...
    // region addLog() =========================================================
    // Creates TextView to add as a workout entry, sets onClick for it,
    public void addLog(final String str_workoutName, final String str_workoutDate,
                       final String str_startTime, final String str_duration,
                       final String str_bodyweight)
    {
        ...
        logEntry.setOnClickListener(new View.OnClickListener() {
            ...
            */
            ...
            public void onClick(View v)
            {
                ...
                Intent goToLogProof = new Intent(Log.this, LogInstance.class);
